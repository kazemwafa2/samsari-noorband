...
const GLASS_PRESETS: GlassPreset[] = [
  {
    ...
    mode: "light",
    swatch: "linear-gradient(135deg,#38BDF8,#1D4ED8)",
    theme: {
      primary: "#1D4ED8",
      secondary: "#38BDF8",
      background: "#E0F2FE",
      cardBg: "#F0F9FF",
      darkText: "#0C4A6E",
      btnGradientStart: "#2563EB",
      btnGradientEnd: "#38BDF8",
      btnText: "#FFFFFF",
      glassBg: "rgba(219,234,254,.45)",
      glassBorder: "rgba(191,219,254,.9)",
      glassBlur: "30px",
    },
  },
  {
    id: "warm-orange",
    label: "🧡 شیشه نارنجی گرم",
    description: "روشن و گرم — دقیقا مطابق نمونه‌ی دوم که فرستادید",
    mode: "light",
    swatch: "linear-gradient(135deg,#FB923C,#9333EA)",
    theme: {
      primary: "#F97316",
      secondary: "#9333EA",
      background: "#FDF2F8",
      cardBg: "#FFFFFF",
      darkText: "#7C2D12",
      btnGradientStart: "#FB923C",
      btnGradientEnd: "#F97316",
      btnText: "#FFFFFF",
      glassBg: "rgba(253,230,138,.35)",
      glassBorder: "rgba(251,146,60,.5)",
      glassBlur: "18px",
    },
  },
  {
